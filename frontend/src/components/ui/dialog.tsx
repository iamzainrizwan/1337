  ...
  return (
    <DialogPortal>
      ...
      >
        {children}
        {showCloseButton && (
          <DialogPrimitive.Close className="absolute top-4 right-4 rounded-md text-fg-dim hover:text-fg-bright transition-colors focus:outline-none">
            <X className="size-4" />
...
function DialogTitle({ className, ...props }: React.ComponentProps<typeof DialogPrimitive.Title>) {
  return (
    <DialogPrimitive.Title
      ...
      className={cn("text-fg-bright font-display text-lg font-semibold", className)}
      {...props}
    />
  )
}
